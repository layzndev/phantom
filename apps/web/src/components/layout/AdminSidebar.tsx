...
import { Activity, Boxes, FileClock, FlaskConical, LayoutDashboard, ServerCog, Settings, Swords } from "lucide-react";
...
const links = [
  ...
  { href: "/services/minecraft", label: "Minecraft", icon: Swords },
